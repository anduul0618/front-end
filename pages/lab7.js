...
export default function Lab4() {
    ...
    return (
        ...
        >
      <button
        className="absolute top-6 right-6 font-bold text-xl bg-gray-800 text-white px-6 py-2 rounded-lg shadow-md z-50
      ...
      <div className="pt-10 min-h-screen px-4 bg-transparent backdrop-blur-sm">
        <h1 className="text-3xl font-bold text-center mb-6 text-gray-white">11c Students</h1>
